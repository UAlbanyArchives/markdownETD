...
%                            ROOT FILE                            %
%
%  Compile with LuaLaTeX to produce a tagged,
%  PDF/UA‑2‑compliant thesis or dissertation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% --- Enable modern PDF management and tagging (MUST be first)
...
% --- Core packages
\usepackage{amssymb, amsmath, latexsym, graphicx, url}
\usepackage{color}    
\usepackage{fancyhdr}
\usepackage[toc, acronym]{glossaries}

% --- Hyperref + REQUIRED explicit PDF metadata
\usepackage{hyperref}
\hypersetup{
  pdftitle   = {My Title},
  pdfauthor  = {My Name},
  pdfsubject = {Doctoral Dissertation},
  pdfkeywords= {asymmetric kernels, eigenfunctions, neural networks, wireless communications}
}

% --- Optional but helpful for caption stability
\usepackage{caption}
